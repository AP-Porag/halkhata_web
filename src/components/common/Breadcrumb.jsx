        ...
        <div>
            <div className="flex justify-between">
                <div className="">
                    ...
                    {/*                </svg>*/}
                    {/*                <a href="#"*/}
                    {/*                   className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Projects</a>*/}
                    {/*            </div>*/}
                    {/*        </li>*/}
                    ...
                    {/*    </ol>*/}
                    {/*</nav>*/}
                    <span className="capitalize font-bold text-gray-500">Welcome back John doe</span>
                </div>
                <div className="">{formatDate(currentDate)}</div>
            </div>
        </div>
    )
}
